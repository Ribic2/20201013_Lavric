...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    updateVideo: function updateVideo() {
      ...
      _Service_Api__WEBPACK_IMPORTED_MODULE_0__["default"].modifyVideo(this.$store.state.videoId, this.$store.state.videoTitle, this.$store.state.videoDescription, this.$store.state.videoLink).then(function (response) {
                          ...
                          [
                            ...
                            _c(
                              ...
                              [
                                ...
                                _vm._v(" "),
                                _c("v-card-text", [_c("h1", [_vm._v("test")])]),
                                _vm._v(" "),
                                _c(
                                  "v-card-actions",
                                  [
        ...
        [
          ...
          _c(
            ...
            [
              _c("v-text-field", {
                attrs: {
                  "return-value": this.$store.state.videoTitle,
                  label: "Video title"
                },
                on: {
                  "update:returnValue": function($event) {
                    return _vm.$set(this.$store.state, "videoTitle", $event)
                  },
              ...
              _vm._v(" "),
              _c("v-textarea", {
                attrs: { "no-resize": "", label: "Video description" },
                on: {
                ...
                model: {
                  ...
                  callback: function($$v) {
                    _vm.$set(this.$store.state, "videoDescription", $$v)
                  },
                  expression: "this.$store.state.videoDescription"
                }
              }),
              _vm._v(" "),
              _c("v-text-field", {
                ...
                model: {
                  ...
                  callback: function($$v) {
                    _vm.$set(this.$store.state, "videoLink", $$v)
                  },
                  expression: "this.$store.state.videoLink"
                }
              }),
              _vm._v(" "),
              _c(
